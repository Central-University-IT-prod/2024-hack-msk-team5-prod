...
from app.internal.services.trips import (create_trip_event_view,
                                         create_trip_view, get_trip_view,
                                         remove_trip)
...
async def delete_trip(
    ...
    result = await remove_trip(session=session, delete_trip_req=body)
    return result
